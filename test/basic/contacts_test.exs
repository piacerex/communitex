defmodule Basic.ContactsTest do
  ...
  describe "contacts" do
    ...
    test "create_contact/1 with valid data creates a contact" do
      valid_attrs = %{body: "some body", deleted_at: ~N[2022-01-12 01:52:00], email: "some email", first_name: "some first_name", first_name_kana: "some first_name_kana", last_name: "some last_name", last_name_kana: "some last_name_kana", logined_user_id: 42, type: "some type"}

      assert {:ok, %Contact{} = contact} = Contacts.create_contact(valid_attrs)
      assert contact.body == "some body"
      assert contact.deleted_at == ~N[2022-01-12 01:52:00]
    ...
    test "update_contact/2 with valid data updates the contact" do
      contact = contact_fixture()
      update_attrs = %{body: "some updated body", deleted_at: ~N[2022-01-13 01:52:00], email: "some updated email", first_name: "some updated first_name", first_name_kana: "some updated first_name_kana", last_name: "some updated last_name", last_name_kana: "some updated last_name_kana", logined_user_id: 43, type: "some updated type"}

      assert {:ok, %Contact{} = contact} = Contacts.update_contact(contact, update_attrs)
      assert contact.body == "some updated body"
      assert contact.deleted_at == ~N[2022-01-13 01:52:00]
