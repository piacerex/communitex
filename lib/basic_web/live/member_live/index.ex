defmodule BasicWeb.MemberLive.Index do
  ...
  def get_and_assign_page(page_number, search) do
    ...
    = Members.paginate_members(page_number, search)
  ...
  defp apply_action(socket, :edit, %{"id" => id, "page" => page_number, "total_pages" => total_pages, "search" => search} = params) do
    socket
    |> assign(:page_title, "Edit Member")
    |> assign(:member, List.first(Members.get_member!(id)))
    |> assign(:page_number, String.to_integer(page_number))
