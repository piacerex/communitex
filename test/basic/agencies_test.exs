defmodule Basic.AgenciesTest do
  ...
  describe "agencies" do
    ...
    @valid_attrs %{boost: 120.5, brand: "some brand", corporate_id: 42, deleted_at: ~N[2010-04-17 14:00:00], discount: 120.5, distributor_id: 42}
