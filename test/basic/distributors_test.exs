defmodule Basic.DistributorsTest do
  ...
  describe "distributors" do
    ...
    @valid_attrs %{brand: "some brand", deleted_at: ~N[2010-04-17 14:00:00], organization_id: 42}
    @update_attrs %{brand: "some updated brand", deleted_at: ~N[2011-05-18 15:01:01], organization_id: 43}
